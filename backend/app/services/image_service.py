...
def _to_absolute_dir(path_value: str) -> str:
...
RAW_IMAGE_DIR = _to_absolute_dir(settings.RAW_IMAGE_DIR)
...
def save_upload_image(upload_file: UploadFile) -> str:
    ...
    file_path = os.path.abspath(os.path.join(RAW_IMAGE_DIR, filename))
...
def run_image_processor(image_path: str):
    ...
    try:
        ...
        processed_dir = _to_absolute_dir(settings.PROCESSED_IMAGE_DIR)
