class RecommendationEngine:
    ...
    def __init__(self):
        ...
        self.recommendation_texts = {
            ...
            """High line pressure, heavy shading, and darker tonal balance may reflect emotionally intense expressive behaviour. Supportive guidance may focus on calming activities and structured emotional outlets (Koppitz, 1984; Machover, 1949).""",

            "Confidence Building Support":
            """Small page usage and reduced figure size may indicate constrained spatial engagement. Encouraging open-ended drawing and positive reinforcement may support expressive confidence (Buck, 1948; Koppitz, 1984).""",

            "Social Engagement Support":
            """Greater distance between figures or separate self-positioning may reflect relational distancing. Collaborative activities and guided social interaction may support engagement (Machover, 1949; Malchiodi, 1998).""",

            "Developmental Monitoring Suggestion":
            """Missing body parts or absent facial features may reflect developmental or expressive simplification. Observation over time is recommended rather than immediate concern (Koppitz, 1968).""",

            "Positive Reinforcement":
            """Balanced tone and organized structure may indicate regulated expression. Reinforcing positive expressive behaviour is recommended (Malchiodi, 2005).""",

            "Expressive Expansion Guidance":
            """Large page usage and confident spatial engagement may indicate strong expressive presence. Encouraging narrative expansion and creative exploration is beneficial (Betts, 1995).""",

            "Creative Encouragement":
            """Absence of strong emotional or spatial constraints may indicate thematic exploration. Encouraging imaginative storytelling and symbolic creativity can enhance development (Machover, 1949)."""
        }

        for key, value in self.recommendation_texts.items():
            sentences = value.split(". ")
            self.recommendation_texts[key] = ". ".join(sentences)
